...
// to construct the registry key for our service:
// System\CurrentControlSet\Services\<Service>\Parameters
#define MAX_SERVICE_REGKEY_LENGTH  MAX_SERVICE_NAME_LENGTH+45
...
//$--HrServiceStartupEx2000-----------------------------------------------------
//  This function is called at startup to initialize the NT service.
//
//  Added to support Exchange 2000
//------------------------------------------------------------------------------
HRESULT HrServiceStartupEx2000(             // RETURNS: return code
    IN HINSTANCE hInstance,             // handle of current instance
    IN HINSTANCE hPrevInstance,         // handle of previous instance
    IN HWND hwndMainWindow,             // handle to main window
    IN LPSTR pszCmdLine);               // pointer to command line
