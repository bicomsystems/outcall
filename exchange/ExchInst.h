...
//
// Copyright 1986 - 2001 Microsoft Corporation.  All Rights Reserved.
//
// (disabled all Exchange 5.5 DAPI stuff because this has to be done using ADSI;
// samples are now based in the snap-ins)
//
// -----------------------------------------------------------------------------
...
//$--HrCreateGatewayProfileEx2000-----------------------------------------------
//  Creates a gateway profile for usage of Exchange 2000
// -----------------------------------------------------------------------------
HRESULT HrCreateGatewayProfileEx2000(          // RETURNS: return code
    IN LPSTR lpszServiceName,              // service name
    IN LPSTR lpszProfileName);             // profile name
